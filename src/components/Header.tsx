...
import { Search, MapPin, Menu, X, User, LogOut, Star, Ticket } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center gap-2">
            ...
            {isLoggedIn ? (
              <>
                <div className="hidden md:flex items-center gap-2 ml-2 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => navigate('/account')}>
                ...
                <Button variant="ghost" size="sm" className="hidden md:flex gap-1.5" onClick={() => navigate('/bookings')}>
          ...
          <div className="md:hidden py-4 animate-slide-up space-y-4">
            ...
            {isLoggedIn ? (
              <div className="space-y-2">
                ...
                <Button variant="outline" className="w-full gap-2" onClick={() => { navigate('/bookings'); setMobileMenuOpen(false); }}>
